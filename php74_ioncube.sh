...
echo -e "\\033[1;34m#### \\033[1;33m  Updated By : XtreamGuru.com       \\033[1;34m #### \\033[0;39m"
...
echo "zend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" > /etc/php/7.4/mods-available/ioncube.ini
sed -i "1izend_extension=/usr/local/ioncube/ioncube_loader_lin_${VER_PHP}.so" /etc/php/7.4/apache2/php.ini
sleep 3s
...
echo -e "\\033[1;32m ####  Installation Complete / IonCube Loaders Now Installed  #### \\033[0;39m"
